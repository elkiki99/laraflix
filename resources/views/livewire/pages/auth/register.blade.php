...
<div>
    <form wire:submit="register">
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="text-sm text-gray-400 underline rounded-md hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800" href="{{ route('login') }}" wire:navigate>
