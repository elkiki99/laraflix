...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
            ...
            @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! auth()->user()->hasVerifiedEmail())
                <div>
                    <p class="mt-2 text-sm text-gray-200">
                        ...
                        <button wire:click.prevent="sendVerification" class="text-sm text-gray-400 underline rounded-md hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800">
        ...
        <div class="flex items-center gap-4">
            <x-primary-button class="px-4">{{ __('Save') }}</x-primary-button>
